...
FAKE_FILES = {'PNG': b'89504e47', 'JPG': 2, 'GIF': 3, 'MP3': b'49443303', 'MP4': 3}
...
def axmlaudit(axml):
    ...
    if application is not None and axml.getPackageName() not in application:
        print("Application : " + application + " : Dynamic Loading\n")
    ...
    risk_permissions = ["android.permission.CALL_PHONE", "android.permission.SEND_SMS",
                        ...
                        "android.permission.WRITE_APN_SETTINGS", "android.permission.WRITE_APN_SETTINGS"
                        ]
