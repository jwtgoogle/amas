...
class AXMLParser:
    ...
    def doNext(self):
        ...
        while True:
            ...
            if chunkType == CHUNK_XML_START_NAMESPACE or \
    ...
    def getName(self):
        if self.m_name == -1 \
                or (self.m_event != START_TAG and self.m_event != END_TAG):
            return ''
    ...
    def getXMLNS(self):
        ...
        for i in self.m_uriprefix:
            if i not in self.visited_ns:
                ...
                namespace_uri = self.sb.getRaw(
                    self.m_prefixuri[self.m_uriprefix[i]])
...
class AXMLPrinter:
    ...
    def __init__(self, raw_buff):
        ...
        while True:
            ...
            if _type == START_DOCUMENT:
                ...
                prefix = self.getPrefix(self.axml.getPrefix()) + \
                    self.axml.getName()
    ...
    def getAttributeValue(self, index):
        ...
        if _type == TYPE_STRING:
            ...
            return "%f%s" % (self.complexToFloat(_data),
